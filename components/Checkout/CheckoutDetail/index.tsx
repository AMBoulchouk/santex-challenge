...
import { getPriceNumber } from "../../../services/utils";
...
const CheckoutDetail = ({ products }: CheckoutDetailProps) => {
  ...
  return (
    <>
      <Container>
        <ProductsContainer>
          <CheckoutSectionTitle>Your Shopping Cart</CheckoutSectionTitle>
        ...
        <PriceInformation>
          ...
          <PayButton onClick={() => setShowPayment(true)}>Let´s Pay!</PayButton>
        </PriceInformation>
      </Container>
      {showPayment && (
        <>
